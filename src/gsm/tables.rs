//! GSM 06.10 RPE dequant tables (ITU / libgsm).

pub(super) const LONG_TERM_GAIN: [i32; 4] = [3277, 11469, 21299, 32767];

/// `xmaxc` 0..63 x pulse amplitude 0..7.
#[rustfmt::skip]
pub(super) const DEQUANT: [[i16; 8]; 64] = [
